...
//1. Each alphabet in the word has an ASCII value (where 'A' = 65, 'B' = 66, ...' = 90(a) = 97, etc.).
//2. Each letter in the word is assigned a 1-based index (i.e., the first letter has index 1, the second letter has index
//  2, and so on).
